...
function closeMenu() {
    ...
    $.post("https://kg-hud/closeMenu");
}
function restartHud() {
    closeMenu();
    $.post("https://kg-hud/restartHud");
}
function resetStorage() {
    closeMenu();
    $.post("https://kg-hud/resetStorage");
}
function showOutMap() {
    $.post("https://kg-hud/showOutMap");
}
function showOutCompass() {
    $.post("https://kg-hud/showOutCompass");
}
function showFollowCompass() {
    $.post("https://kg-hud/showFollowCompass");
}
function openMenuSounds() {
    $.post("https://kg-hud/openMenuSounds");
}
function resetHudSounds() {
    $.post("https://kg-hud/resetHudSounds");
}
function checklistSounds() {
    $.post("https://kg-hud/checklistSounds");
}
function showMapNotif() {
    $.post("https://kg-hud/showMapNotif");
}
function showFuelAlert() {
    $.post("https://kg-hud/showFuelAlert");
}
function showCinematicNotif() {
    $.post("https://kg-hud/showCinematicNotif");
}
function dynamicHealth() {
    $.post("https://kg-hud/dynamicHealth");
}
function dynamicArmor() {
    $.post("https://kg-hud/dynamicArmor");
}
function dynamicHunger() {
    $.post("https://kg-hud/dynamicHunger");
}
function dynamicThirst() {
    $.post("https://kg-hud/dynamicThirst");
}
function dynamicStress() {
    $.post("https://kg-hud/dynamicStress");
}
function dynamicOxygen() {
    $.post("https://kg-hud/dynamicOxygen");
}
function dynamicEngine() {
    $.post("https://kg-hud/dynamicEngine");
}
function dynamicNitro() {
    $.post("https://kg-hud/dynamicNitro");
}
function ToggleMapShape() {
    $.post("https://kg-hud/ToggleMapShape");
}
function changeFPS() {
    $.post("https://kg-hud/changeFPS");
}
function ToggleMapBorders() {
    $.post("https://kg-hud/ToggleMapBorders");
}
function HideMap() {
    $.post("https://kg-hud/HideMap");
}
function changeCompassFPS() {
    $.post("https://kg-hud/changeCompassFPS");
}
function showCompassBase() {
    $.post("https://kg-hud/showCompassBase");
}
function showStreetsNames() {
    $.post("https://kg-hud/showStreetsNames");
}
function showPointerIndex() {
    $.post("https://kg-hud/showPointerIndex");
}
function showDegreesNum() {
    $.post("https://kg-hud/showDegreesNum");
}
function cinematicMode() {
    $.post("https://kg-hud/cinematicMode");
}
